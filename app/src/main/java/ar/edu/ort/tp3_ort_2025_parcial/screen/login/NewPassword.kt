...
fun NewPassword(navController: NavController) {
    ...
    Box(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.padding(32.dp))
            Input1(stringResource(R.string.new_password_place_holder), "", onValueChange = { password = it }, false)
            Spacer(modifier = Modifier.padding(16.dp))
            Input1(stringResource(R.string.confirm_password_place_holder), "", onValueChange = { confirmPassword = it }, false)
